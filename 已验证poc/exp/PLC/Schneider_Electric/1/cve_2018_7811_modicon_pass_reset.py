...
with urllib.request.urlopen('http://'+host+':'+str(port)+'/unsecure/embedded/builtin?Language=English&user='+user+'&passwd='+newpass+'&cnfpasswd='+newpass+'&subhttppwd=Save+User') as f:
    print(f.read(300))